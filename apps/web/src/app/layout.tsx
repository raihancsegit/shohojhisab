...
function SideMenuDrawer({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  const menuItems = [
    { href: '/calculator', label: 'ক্যালকুলেটর', icon: '🔢', iconBg: '#ecfdf5', iconColor: '#059669', badge: 'হট' },
    { href: '/pos?voice=1', label: 'ভয়েস মেমো', icon: '🎙️', iconBg: '#eff6ff', iconColor: '#2563eb', badge: 'স্মার্ট' },
    { href: '/pos', label: 'ক্যাশ কাউন্টার', icon: '🛒', iconBg: '#eef2ff', iconColor: '#4f46e5' },
    ...
    { href: '/tutorials', label: 'টিউটোরিয়াল', icon: '🎬', iconBg: '#eef2ff', iconColor: '#4f46e5', badge: 'ভিডিও' },
    { href: '/voice-guide', label: 'ভয়েস গাইড', icon: '🎙️', iconBg: '#ecfdf5', iconColor: '#059669', badge: 'এআই' },
  ];
